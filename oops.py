...
#     pass
#
# fr = First()  ### creating an instance of a class First and assigning it to fr
# second_instance = First() ### this guy is a singer
#
# print fr
# print type(fr)
# print type(First)
...
# p.name = "Peter"
# p.singer = True
# print "%s is %s years old" % (p.name, p.age)
# print "Is he a singer? %s" % p.singer
